const HomePageAgoda = require('cypress/support/page-object/Agoda/homepage')
const FlightList = require('cypress/support/page-object/Agoda/flightlist');
const DataPassenger = require('cypress/support/page-object/Agoda/datapassenger');

const HomePageAmazon = require('cypress/support/page-object/Amazon/homepage');
const ListProduct = require('cypress/support/page-object/Amazon/listproduct');

const HomePage = require('cypress/support/page-object/Youtube/homepage');
const Trending = require('cypress/support/page-object/Youtube/trending');
